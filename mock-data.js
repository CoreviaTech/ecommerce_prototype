  ...
  commerceFixtures: {
    ...
    delivery: {
      ...
      "multiple-methods": {
        ...
        methods: [
          { id: "standard-demo", feeVnd: 35000, label: "Giao tiêu chuẩn", estimateLabel: "2–3 ngày làm việc", source: "carrier-quote-demo" },
          { id: "careful-demo", feeVnd: 68000, label: "Giao tăng cường cho hàng dễ vỡ", estimateLabel: "2–3 ngày làm việc", source: "carrier-quote-demo" }
        ],
        customerText: "Chọn một phương án vận chuyển phù hợp với bạn."
      },
      "zone-fallback": { methodId: "zone-standard-demo", feeVnd: 40000, totalFinal: true, methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", estimateLabel: "3–4 ngày làm việc", source: "zone-table-demo" },
      "manual-quote": { methodId: "manual-delivery-request", feeVnd: null, totalFinal: false, methodLabel: "HEDY xác nhận phí riêng", customerText: "Đơn hàng có sản phẩm gốm đặc biệt hoặc kiện lớn; HEDY sẽ liên hệ báo cước an toàn trực tiếp." },
      unsupported: { feeVnd: null, totalFinal: false, customerText: "Địa chỉ mẫu nằm ngoài vùng được cấu hình; vui lòng mở lựa chọn liên hệ." },
      ...
      provinceRates: {
        ...
        "Hà Nội": {
          ...
          methodLabel: "Giao tiêu chuẩn",
          region: "north",
          methods: [
            { id: "standard-demo", feeVnd: 35000, label: "Giao tiêu chuẩn", estimateLabel: "2–3 ngày làm việc" },
            { id: "careful-demo", feeVnd: 68000, label: "Giao tăng cường cho hàng dễ vỡ", estimateLabel: "2–3 ngày làm việc" }
          ]
        },
        "Đà Nẵng": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "central" },
        "Bình Dương": { feeVnd: 30000, estimateLabel: "1–2 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Đồng Nai": { feeVnd: 30000, estimateLabel: "1–2 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Bà Rịa - Vũng Tàu": { feeVnd: 30000, estimateLabel: "1–2 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Long An": { feeVnd: 30000, estimateLabel: "1–2 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Tây Ninh": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Bình Phước": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Cần Thơ": { feeVnd: 30000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Tiền Giang": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Bến Tre": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Vĩnh Long": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Trà Vinh": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Hậu Giang": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Sóc Trăng": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Bạc Liêu": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Cà Mau": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Kiên Giang": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "An Giang": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Đồng Tháp": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao tiêu chuẩn", region: "south" },
        "Thừa Thiên Huế": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Quảng Nam": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Quảng Ngãi": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Bình Định": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Phú Yên": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Khánh Hòa": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Ninh Thuận": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Bình Thuận": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Lâm Đồng": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "highland" },
        "Đắk Lắk": { feeVnd: 45000, estimateLabel: "3–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "highland" },
        "Đắk Nông": { feeVnd: 45000, estimateLabel: "3–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "highland" },
        "Gia Lai": { feeVnd: 45000, estimateLabel: "3–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "highland" },
        "Kon Tum": { feeVnd: 45000, estimateLabel: "3–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "highland" },
        "Quảng Trị": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Quảng Bình": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Hà Tĩnh": { feeVnd: 40000, estimateLabel: "3–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Nghệ An": { feeVnd: 40000, estimateLabel: "3–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Thanh Hóa": { feeVnd: 40000, estimateLabel: "3–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "central" },
        "Hải Phòng": { feeVnd: 35000, estimateLabel: "2–3 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Quảng Ninh": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Bắc Ninh": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Bắc Giang": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Hải Dương": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Hưng Yên": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Hà Nam": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Nam Định": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Thái Bình": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Ninh Bình": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Vĩnh Phúc": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Phú Thọ": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Thái Nguyên": { feeVnd: 40000, estimateLabel: "2–4 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Hòa Bình": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Lạng Sơn": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Tuyên Quang": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Yên Bái": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Lào Cai": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Sơn La": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Điện Biên": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Lai Châu": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Hà Giang": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Cao Bằng": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Bắc Kạn": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "north" },
        "Tỉnh / Thành phố khác": { feeVnd: 45000, estimateLabel: "3–5 ngày làm việc", methodLabel: "Giao hàng liên tỉnh tiêu chuẩn", region: "other" }
      },
      provinceDistricts: {
        ...
        "Hải Phòng": [
          ...
          "Huyện Thủy Nguyên", "Huyện An Dương", "Huyện An Lão", "Huyện Kiến Thụy", "Huyện Tiên Lãng", "Huyện Vĩnh Bảo", "Huyện Cát Hải"
        ],
        "Cần Thơ": [
          "Quận Ninh Kiều", "Quận Bình Thủy", "Quận Cái Răng", "Quận Ô Môn", "Quận Thốt Nốt", "Huyện Phong Điền", "Huyện Cờ Đỏ", "Huyện Thới Lai", "Huyện Vĩnh Thạnh"
        ],
        "Bình Dương": [
          "TP. Thủ Dầu Một", "TP. Thuận An", "TP. Dĩ An", "TP. Tân Uyên", "TP. Bến Cát", "Huyện Bàu Bàng", "Huyện Bắc Tân Uyên", "Huyện Dầu Tiếng", "Huyện Phú Giáo"
        ],
        "Đồng Nai": [
          "TP. Biên Hòa", "TP. Long Khánh", "Huyện Long Thành", "Huyện Nhơn Trạch", "Huyện Trảng Bom", "Huyện Thống Nhất", "Huyện Cẩm Mỹ", "Huyện Vĩnh Cửu", "Huyện Xuân Lộc", "Huyện Định Quán", "Huyện Tân Phú"
        ],
        "Bà Rịa - Vũng Tàu": [
          "TP. Vũng Tàu", "TP. Bà Rịa", "Thị xã Phú Mỹ", "Huyện Châu Đức", "Huyện Đất Đỏ", "Huyện Long Điền", "Huyện Xuyên Mộc", "Huyện Côn Đảo"
        ],
        "Long An": [
        ...
        "Tây Ninh": [
          "TP. Tây Ninh", "Thị xã Hòa Thành", "Thị xã Trảng Bàng", "Huyện Bến Cầu", "Huyện Châu Thành", "Huyện Dương Minh Châu", "Huyện Gò Dầu", "Huyện Tân Biên", "Huyện Tân Châu"
        ],
        "Bình Phước": [
        ...
        "Tiền Giang": [
          "TP. Mỹ Tho", "Thị xã Gò Công", "Thị xã Cai Lậy", "Huyện Cái Bè", "Huyện Cai Lậy", "Huyện Châu Thành", "Huyện Chợ Gạo", "Huyện Gò Công Đông", "Huyện Gò Công Tây", "Huyện Tân Phước", "Huyện Tân Phú Đông"
        ],
        "Bến Tre": [
        ...
        "Hậu Giang": [
          "TP. Vị Thanh", "TP. Ngã Bảy", "Thị xã Long Mỹ", "Huyện Châu Thành", "Huyện Châu Thành A", "Huyện Phụng Hiệp", "Huyện Vị Thủy", "Huyện Long Mỹ"
        ],
        "Sóc Trăng": [
          "TP. Sóc Trăng", "Thị xã Vĩnh Châu", "Thị xã Ngã Năm", "Huyện Châu Thành", "Huyện Cù Lao Dung", "Huyện Kế Sách", "Huyện Long Phú", "Huyện Mỹ Tú", "Huyện Mỹ Xuyên", "Huyện Thạnh Trị", "Huyện Trần Đề"
        ],
        "Bạc Liêu": [
          "TP. Bạc Liêu", "Thị xã Giá Rai", "Huyện Đông Hải", "Huyện Hòa Bình", "Huyện Hồng Dân", "Huyện Phước Long", "Huyện Vĩnh Lợi"
        ],
        "Cà Mau": [
          "TP. Cà Mau", "Huyện Cái Nước", "Huyện Đầm Dơi", "Huyện Năm Căn", "Huyện Ngọc Hiển", "Huyện Phú Tân", "Huyện Thới Bình", "Huyện Trần Văn Thời", "Huyện U Minh"
        ],
        "Kiên Giang": [
          "TP. Rạch Giá", "TP. Hà Tiên", "TP. Phú Quốc", "Huyện An Biên", "Huyện An Minh", "Huyện Châu Thành", "Huyện Giang Thành", "Huyện Giồng Riềng", "Huyện Gò Quao", "Huyện Hòn Đất", "Huyện Kiên Hải", "Huyện Kiên Lương", "Huyện Tân Hiệp", "Huyện U Minh Thượng", "Huyện Vĩnh Thuận"
        ],
        "An Giang": [
          "TP. Long Xuyên", "TP. Châu Đốc", "Thị xã Tân Châu", "Thị xã Tịnh Biên", "Huyện An Phú", "Huyện Châu Phú", "Huyện Châu Thành", "Huyện Chợ Mới", "Huyện Phú Tân", "Huyện Thoại Sơn", "Huyện Tri Tôn"
        ],
        "Đồng Tháp": [
        ...
        "Thừa Thiên Huế": [
          "TP. Huế", "Thị xã Hương Thủy", "Thị xã Hương Trà", "Huyện A Lưới", "Huyện Nam Đông", "Huyện Phong Điền", "Huyện Phú Lộc", "Huyện Phú Vang", "Huyện Quảng Điền"
        ],
        "Quảng Nam": [
          "TP. Tam Kỳ", "TP. Hội An", "Thị xã Điện Bàn", "Huyện Bắc Trà My", "Huyện Duy Xuyên", "Huyện Đại Lộc", "Huyện Đông Giang", "Huyện Hiệp Đức", "Huyện Nam Giang", "Huyện Nam Trà My", "Huyện Nông Sơn", "Huyện Núi Thành", "Huyện Phú Ninh", "Huyện Phước Sơn", "Huyện Quế Sơn", "Huyện Tây Giang", "Huyện Thăng Bình", "Huyện Tiên Phước"
        ],
        "Quảng Ngãi": [
        ...
        "Bình Định": [
          "TP. Quy Nhơn", "Thị xã An Nhơn", "Thị xã Hoài Nhơn", "Huyện An Lão", "Huyện Hoài Ân", "Huyện Phù Cát", "Huyện Phù Mỹ", "Huyện Tuy Phước", "Huyện Tây Sơn", "Huyện Vân Canh", "Huyện Vĩnh Thạnh"
        ],
        "Phú Yên": [
          "TP. Tuy Hòa", "Thị xã Sông Cầu", "Thị xã Đông Hòa", "Huyện Đồng Xuân", "Huyện Phú Hòa", "Huyện Sơn Hòa", "Huyện Sông Hinh", "Huyện Tây Hòa", "Huyện Tuy An"
        ],
        "Khánh Hòa": [
        ...
        "Ninh Thuận": [
          "TP. Phan Rang - Tháp Chàm", "Huyện Bác Ái", "Huyện Ninh Hải", "Huyện Ninh Phước", "Huyện Ninh Sơn", "Huyện Thuận Bắc", "Huyện Thuận Nam"
        ],
        "Bình Thuận": [
        ...
        "Lâm Đồng": [
          "TP. Đà Lạt", "TP. Bảo Lộc", "Huyện Bảo Lâm", "Huyện Cát Tiên", "Huyện Di Linh", "Huyện Đạ Huoai", "Huyện Đạ Tẻh", "Huyện Đam Rông", "Huyện Đơn Dương", "Huyện Đức Trọng", "Huyện Lạc Dương", "Huyện Lâm Hà"
        ],
        "Đắk Lắk": [
        ...
        "Gia Lai": [
          "TP. Pleiku", "Thị xã An Khê", "Thị xã Ayun Pa", "Huyện Chư Păh", "Huyện Chư Prông", "Huyện Chư Pưh", "Huyện Chư Sê", "Huyện Đắk Đoa", "Huyện Đắk Pơ", "Huyện Đức Cơ", "Huyện Ia Grai", "Huyện Ia Pa", "Huyện K'Bang", "Huyện Kông Chro", "Huyện Krông Pa", "Huyện Mang Yang", "Huyện Phú Thiện"
        ],
        "Kon Tum": [
          "TP. Kon Tum", "Huyện Đắk Glei", "Huyện Đắk Hà", "Huyện Đắk Tô", "Huyện Ia H'Drai", "Huyện Kon Plông", "Huyện Kon Rẫy", "Huyện Ngọc Hồi", "Huyện Sa Thầy", "Huyện Tu Mơ Rông"
        ],
        "Quảng Trị": [
        ...
        "Quảng Ninh": [
          "TP. Hạ Long", "TP. Móng Cái", "TP. Cẩm Phả", "TP. Uông Bí", "Thị xã Đông Triều", "Thị xã Quảng Yên", "Huyện Ba Chẽ", "Huyện Bình Liêu", "Huyện Cô Tô", "Huyện Đầm Hà", "Huyện Hải Hà", "Huyện Tiên Yên", "Huyện Vân Đồn"
        ],
        "Bắc Ninh": [
        ...
        "Nam Định": [
          "TP. Nam Định", "Huyện Giao Thủy", "Huyện Hải Hậu", "Huyện Mỹ Lộc", "Huyện Nam Trực", "Huyện Nghĩa Hưng", "Huyện Trực Ninh", "Huyện Vụ Bản", "Huyện Xuân Trường", "Huyện Ý Yên"
        ],
        "Thái Bình": [
          "TP. Thái Bình", "Huyện Đông Hưng", "Huyện Hưng Hà", "Huyện Kiến Xương", "Huyện Quỳnh Phụ", "Huyện Thái Thụy", "Huyện Tiền Hải", "Huyện Vũ Thư"
        ],
        "Ninh Bình": [
          "TP. Ninh Bình", "TP. Tam Điệp", "Huyện Gia Viễn", "Huyện Hoa Lư", "Huyện Kim Sơn", "Huyện Nho Quan", "Huyện Yên Khánh", "Huyện Yên Mô"
        ],
        "Vĩnh Phúc": [
          "TP. Vĩnh Yên", "TP. Phúc Yên", "Huyện Bình Xuyên", "Huyện Lập Thạch", "Huyện Sông Lô", "Huyện Tam Đảo", "Huyện Tam Dương", "Huyện Vĩnh Tường", "Huyện Yên Lạc"
        ],
        "Phú Thọ": [
        ...
        "Lào Cai": [
          "TP. Lào Cai", "Thị xã Sa Pa", "Huyện Bát Xát", "Huyện Bảo Thắng", "Huyện Bảo Yên", "Huyện Bắc Hà", "Huyện Mường Khương", "Huyện Si Ma Cai", "Huyện Văn Bàn"
        ],
        "Sơn La": [
          "TP. Sơn La", "Huyện Bắc Yên", "Huyện Mai Sơn", "Huyện Mộc Châu", "Huyện Mường La", "Huyện Phù Yên", "Huyện Quỳnh Nhai", "Huyện Sông Mã", "Huyện Sốp Cộp", "Huyện Thuận Châu", "Huyện Vân Hồ", "Huyện Yên Châu"
        ],
        "Điện Biên": [
          "TP. Điện Biên Phủ", "Thị xã Mường Lay", "Huyện Điện Biên", "Huyện Điện Biên Đông", "Huyện Mường Ảng", "Huyện Mường Chà", "Huyện Mường Nhé", "Huyện Nậm Pồ", "Huyện Tủa Chùa", "Huyện Tuần Giáo"
        ],
        "Lai Châu": [
          "TP. Lai Châu", "Huyện Mường Tè", "Huyện Nậm Nhùn", "Huyện Phong Thổ", "Huyện Sìn Hồ", "Huyện Tam Đường", "Huyện Tân Uyên", "Huyện Than Uyên"
        ],
        "Hà Giang": [
          "TP. Hà Giang", "Huyện Bắc Mê", "Huyện Bắc Quang", "Huyện Đồng Văn", "Huyện Hoàng Su Phì", "Huyện Mèo Vạc", "Huyện Quản Bạ", "Huyện Quang Bình", "Huyện Vị Xuyên", "Huyện Xín Mần", "Huyện Yên Minh"
        ],
        "Cao Bằng": [
        ...
        "Tỉnh / Thành phố khác": [
          "Khu vực trung tâm TP / Thị xã", "Khu vực Huyện lân cận"
        ]
      }
    },
    payment: {
