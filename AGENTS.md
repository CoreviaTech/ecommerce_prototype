...
- `checkout.html`: guest recipient/address flow with session draft recovery, validation, delivery calculation states, and payment/submission kept at the Phase 7 boundary.
